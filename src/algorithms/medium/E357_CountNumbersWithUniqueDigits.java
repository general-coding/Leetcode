 ...
 * 
 *         2. Backtracking should contains three states which are (the current
 ...
 * 
 *         4. Let f(k) = count of numbers with unique digits with length equals
 *         k.
 * 
 *         5. f(1) = 10, ..., f(k) = 9 * 9 * 8 * ... (9 - k + 2) [The first
...
public class E357_CountNumbersWithUniqueDigits {
	...
	public static void main(String[] args) {
		System.out.println(new E357_CountNumbersWithUniqueDigits().countNumbersWithUniqueDigits(2));
	}
